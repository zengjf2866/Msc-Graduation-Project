...
AmplitudeExcitedHarm = 10*ones(nu, nh);
...
[CZ_S, Z_S, freq, Complementrary_Sensitivity, CvecG_S, dof_S, CL_S] = ArbLocalPolyAnal(cs_2, method);

%%
CS = frd(Control_Sensitivity,freq,FrequencyUnit='Hz');
CS_2 = frd(Complementrary_Sensitivity,freq,FrequencyUnit='Hz');
H = -inv(CS)*CS_2;
